...
translation_columns = {
    ...
    "Haben Sie schon von Technologien zur Entnahme von Kohlendioxid (CO2) aus der Luft (auf Englisch Direct Air Capture (DAC)) gehört?": "Have you heard about Direct Air Capture (DAC) technologies?",
    ...
    "Emissionen zu reduzieren wäre kosteneffizienter als DAC.": "Reducing CO2 emissions would be more cost efficient than using DAC",
    ...
    "DAC könnte dazu beitragen, schwer vermeidbare Emissionen aus Sektoren wie Landwirtschaft oder Zementproduktion zu entnehmen.": "DAC could help capture emissions from hard-to-abate sectors such as agriculture or cement production",
    "Die Implementierung von DAC als Teil einer Gesamtstrategie kann Deutschland dabei helfen, seine Klimaziele zu erreichen und den Klimawandel auf 1,5 °C zu begrenzen.": "Including DAC as a part of an overall strategy can help Germany achieve its climate goals and limit climate change to 1.5°C",
    "DAC ist eine effiziente Technologie zur Bekämpfung des Klimawandels.": "DAC is an efficient technology to fight climate change",
